package com.sinaukoding.event_booking_system.service.managementuser.impl;
...
import com.sinaukoding.event_booking_system.mapper.managementuser.UserMapper;
...
public class UserServiceImpl implements UserService {
    ...
    public void register(RegisterRequestRecord request) {
        UserRequestRecord newUserRequest = new UserRequestRecord(
                null,
                request.nama(),
                request.username(),
                request.email(),
